...
{
    public abstract class PizzaMarketWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PizzaMarketWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PizzaMarketWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PizzaMarketDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PizzaMarketDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PizzaMarketDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PizzaMarketDbContext, Task<T>> func)
        {
            T result;
